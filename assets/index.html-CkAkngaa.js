import{_ as f,b as o,r as b,o as _,h as g,p as x,g as a,e as n,t as $,E as y,c as A,a as t,f as l}from"./app-Cx0zDz_B.js";import{_ as D}from"./logo-CuOPLjxS.js";const k="https://cli.avuejs.com/api/area",S={__name:"remote",setup(v,{expose:s}){s();const r=o({province:"110000",province1:"110000,120000,130000,140000"}),e=o({column:[{label:"提及框",prop:"province",type:"mention",remote:!0,value:"@",props:{label:"name",value:"code"},dicUrl:`${k}/getProvince?id={{key}}`,rules:[{required:!0,message:"请选择省份",trigger:"blur"}]}]}),d={baseUrl:k,form:r,option:e,ref:o};return Object.defineProperty(d,"__isScriptSetup",{enumerable:!1,value:!0}),d}};function P(v,s,r,e,d,m){const p=b("tvue-form");return _(),g(p,{option:e.option,modelValue:e.form,"onUpdate:modelValue":s[0]||(s[0]=c=>e.form=c)},null,8,["option","modelValue"])}const j=f(S,[["render",P],["__file","remote.vue"]]),C={__name:"slot",setup(v,{expose:s}){s();const r=o({province:"120000"}),e=o({column:[{label:"提及框",prop:"province",type:"mention",value:"@",props:{label:"name",value:"code"},dicUrl:"https://cli.avuejs.com/api/area/getProvince",typeformat(c,i,u){return`值:${c[i]}-名:${c[u]}`},change(c){d()},rules:[{required:!0,message:"请选择省份",trigger:"blur"}]}]});function d(c){x(()=>{const i=m.value.getPropRef("province");if(i){const u=i.$el.querySelector("img");u&&u.setAttribute("style",`
